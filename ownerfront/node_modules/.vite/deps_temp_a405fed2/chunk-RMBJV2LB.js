...
var _excluded7 = ["action", "children", "disabled", "focusableWhenDisabled", "onFocusVisible", "slotProps", "slots"];
...
function useListChangeNotifiers() {
  ...
  const notifySelectionChanged = React29.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React29.useCallback((newHighlightedItem) => {
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React46.useState(value ? String(value) : void 0);
  React46.useEffect(() => {
...
var Option = React50.memo(React50.forwardRef(function Option2(props, forwardedRef) {
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime32.jsx)(React55.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RMBJV2LB.js.map
